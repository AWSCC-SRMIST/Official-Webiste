  ...
  return (
    <section className="join-section">
      <div className="join-container">
        ...
        <p className="join-coming-sub">
          Stay tuned — follow us to know when applications open.
        </p>
        ...
        <div className="join-domains-grid">
          {domains.map((d, i) => (
            <div
              key={i}
              className="join-domain-card"
              style={{ "--domain-color": d.color }}
            >
              <div
                className="join-domain-icon"
              ...
              <div className="join-domain-roles">
                {d.roles.map((r, j) => (
                  <span key={j} className="join-domain-role">
                    {r}
                  </span>
                ))}
              </div>
